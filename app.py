...
def index(subpath):
    ...
    for name in sorted(os.listdir(folder)):
        # Don't show hidden files/folders (allow for subfolders that can only be reached via direct link)
...
# Serve the assets (icons and junk)
